...
<div class="wrapper">
                ...
                <div value="<?php echo $id; ?>" class="cat_frame">
                    <div class="cat_content">
                        <center>
                            <div class="col-md-12">
                                <h3><?php echo $cat; ?></h3>
                                <button type="button" name="button" class="btn btn-primary" name="edit" title="Bewerken" data-toggle="modal" data-target="#editCat" data-id="<?php echo $id; ?>">Bijwerken</button>
                            </div>
                        </center>
                    </div>
                </div>
  ...
  <div class="modal fade"  id="editCat">
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  <h2 class="modal-title">Categorie Gegevens Wijzigen</h2>
              </div>
  ...
  <script type="text/javascript">
    ...
    $('#editCat').on('show.bs.modal', function (event) {
          ...
          var dataString = 'id=' + recipient;
            $.ajax({
                type: "GET",
                url: "api/edit/editCat.php",
                data: dataString,
                cache: false,
                success: function (data) {
                    console.log(data);
                    modal.find('.cat_info').html(data);
                },
                error: function(err) {
                    console.log(err);
                }
