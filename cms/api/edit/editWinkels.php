...
include '../../../config.php';
    if (isset($_POST['updaten'])) {
      ...
      $sql_owner = "SELECT owner_id FROM stores WHERE store_id = '$store_id'";
      $query = $conn->query($sql_owner);
      $result = $query->fetch_assoc();

      $owner_id = $result['owner_id'];
      header("location:../klantwinkels.php?id=" . $owner_id);
    }
    else {
        $store_id = $_GET['id'];
...
<form method="POST" action="edit/editWinkels.php" role="form">
