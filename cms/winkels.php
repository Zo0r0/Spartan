    ...
    <section class="content">
        <div class="row">
          <div class="col-lg-2 col-xs-3">
            <div class="box-nb">
                <button type="button" name="button" class="add btn btn-danger" data-toggle="modal" data-target="#addStore"><i class="fa fa-plus fa-2x"></i></button>
            </div>
          </div>
        </div>
        <div class="row">
                ...
                <div class="store_frame">
                    <div class="store_content">
                        <div value="<?php echo $id; ?>" class="col-md-12">
                            ...
                            <button type="button" name="button" class="btn btn-primary" name="edit" title="Bewerken" data-toggle="modal" data-target="#editStores" data-id="<?php echo $id; ?>">Bijwerken</button>
  ...
  <script type="text/javascript">
    ...
    $('#editStores').on('show.bs.modal', function (event) {
          ...
          var dataString = 'id=' + recipient;
            $.ajax({
                type: "GET",
                url: "api/edit/editWinkels_Page.php",
                data: dataString,
                cache: false,
