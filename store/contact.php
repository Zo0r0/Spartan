	...
	<section class="bgwhite p-b-38">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="hov-img-zoom-contact">
				...
				<div class="col-md-3 p-b-30">
					<form class="leave-comment">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="name" placeholder="Naam">
						</div>
						...
						<div class="w-size25">
							...
							<button name="sturen" class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4">
								Send
							</button>
						</div>
					</form>
		...
		<div class="flex-w p-b-90">
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					...
					<li class="p-b-9">
						<a href="winkels.php" class="s-text7">
							Alle Winkels
						</a>
					</li>
